function skeleton_police_walking_func(reload=0, //the runtime delay between two shoots. Min: -78
	shoot_func=function(lead_l, lead_r){ //a shooting function parameter so you can make costumize shoots
		new_bullet(this.x+25*this.dir, this.y-23, this.team, this.dir*55, -1, 0, 0.4, 0.002, 16);
		new_bullet(this.x+25*this.dir, this.y-23, this.team, this.dir*55, -2, 0, 0.4, 0.002, 16);
		new_bullet(this.x+25*this.dir, this.y-23, this.team, this.dir*55, -3, 0, 0.4, 0.002, 16);
	},
